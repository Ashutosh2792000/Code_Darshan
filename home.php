...
<body style="font-family: 'Poppins', sans-serif;">
    ...
    <nav class="navbar navbar-expand-lg  bg-warning">
        <div class="container-fluid">
            <a class="navbar-brand" href="home.php">Code दर्शन..</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="http://localhost/damodar/quizAFTERLOGIN.html">QUIZES</a></li>
...
<script>
    ...
    <hr>
    <h3 class="text-shadow-1">Welcome to Code_Darshan</h1>
                    ...
                    <div class="col-md-6">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
                            <div class="card-body d-flex flex-column align-items-start">
                                <strong class="d-inline-block mb-2 text-primary">SKELETON</strong>
                                <h3 class="">
                    ...
                    <div class="col-md-6">
                        <div class="card flex-md-row mb-4 box-shadow h-md-250">
                            <div class="card-body d-flex flex-column align-items-start">
                                ...
                                <h3 class="">
                                    <a class="text-danger" href="upcoming.html">J-query</a>
                                </h3>
...
<footer class="bg-dark text-center text-white my-4">
            ...
            <body class="text-center"><!-- Button trigger modal -->
        ...
        <i class="fa-solid fa-arrow-up-left-from-circle fa-bounce"></i>
            ...
            <script>
                var Typed = new Typed(".auto-type", {
                    strings: ["HTML", "CSS", "JavaScript", "Bootstrap", "j-Query"],
                    typeSpeed: 50,
                    backSpeed: 5,
                    loop: true
                })
